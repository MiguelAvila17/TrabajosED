...
bool ArbolFS::touch(const std::string& nombre, const std::string& contenido){ auto a=std::make_shared<Nodo>(siguienteId_++, nombre, TipoNodo::Archivo, contenido); index_[nombre].push_back(a); return actual_->agregarHijo(a); }
